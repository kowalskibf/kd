<?php
    ...
    if(isset($_SESSION['steamid']))
    {
        if($_SESSION['rank'] > 1000)
        {
            ...
            $connection->query("TRUNCATE eff_upgrader_right_desc");
            for($i=0;$i<$items_ilosc;$i++)
            {
                ...
                $connection->query("INSERT INTO eff_upgrader_right_desc VALUES (NULL, '$itemid', '$skinname', '$skinskin', '$rarity', '$skinimg', '$skincond', '$skinprice')");
            }
        }
        else
        {
